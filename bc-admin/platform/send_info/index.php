			...
			<div class="box-content" id="container_flex" style="padding:0px;">                     
                    <table border="0" width="100%" id="table_scroll">
                        <tr>
							<td>
							<div class="span10">
		    <form method="post" action="add.php" accept-charset="UTF-8" id="contacts-form">
				<div class="row-fluid cle"> 
				<select  class="required" name="statuts" data-array="12,12,Destination*">
				 ...
				 <option value="DM"> DM </option>
                  ...
                  <div class="row-fluid cle">  
                    <input type="text" class="required" name="Sujet" id="Sujet" value="" data-array="12,12,Sujet*" />
                  </div>   
                  <div class="row-fluid cle"> 
                    <textarea name="message" id="message" class="required squared" rows="10" data-array="12,12,Description*"></textarea>
                  </div>                       
                  <strong class="text-info pull-right cle"><small><?php echo $lang_client_['contacts']['NOTICE_FIELDS_MANDATORY']; ?></small></strong>
                  <div class="clearfix"></div>
                   <div class="row-fluid"> 
						<input type="Submit" name="messagebtn" Value="Envoyer"/>
                  </div>                                                                                  
              </form>
							</div>
							</td>
