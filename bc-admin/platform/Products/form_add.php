             ...
             <div class="row-fluid">
              <div class="span6">  
				  ...
				  <?php $random_code = random_cod(10);	?>
                    ...
                    <input type="text" class="required" name="code" readonly id="code" value="<?php echo $random_code;?>" data-array="12,6,<?php echo $lang_['products']['FIELD_CODE']; ?>" />  
                  </div> 
                  <div class="row-fluid">
                  ...
                  <div class="row-fluid"> 
                    <input type="text" class="number" name="tax" id="tax" value="<?php echo $tax_percentage; ?>" data-array="12,6,<?php echo $lang_['products']['FIELD_TAX']; ?>" />
                    <input type="text" class="number" name="point" id="point" value="" data-array="12,6,<?php echo $lang_['products']['FIELD_POINT']; ?>" />
