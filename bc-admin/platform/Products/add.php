...
/***************** / upload ***********/					
 ...
 /* ATTRIBUTES */     
  $record = 'images,url_image,name,file_name,categories,code,price,offer,tax,point,price_with_tax,description,attributes,options,add_data,by_exposure,unlimited_availability,';
