                        ...
                        <table class="table table-striped table-hover">
                            ...
                            <tr>
                                ...
                                <td>                                
                                  <select class="required" name="registration_type" id="registration_type" data-array="12,12,">
                                    <option value="1"<?php echo ((isset($registration_type) && $registration_type == 1) || !isset($registration_type) ? ' selected' : ''); ?>><?php echo $lang_['settings']['FIELD_CUSTOMER_REGISTRATION_TYPE_VALUE_BY_ADMIN']; ?></option>
                                    <option value="0"<?php echo ((isset($registration_type) && $registration_type == 0) ? ' selected' : ''); ?>><?php echo $lang_['settings']['FIELD_CUSTOMER_REGISTRATION_TYPE_VALUE_IMMEDIATE']; ?></option>                                    
                                    <option value="2"<?php echo ((isset($registration_type) && $registration_type == 2) ? ' selected' : ''); ?>><?php echo $lang_['settings']['FIELD_CUSTOMER_REGISTRATION_TYPE_VALUE_BY_EMAIL']; ?></option>
                                  </select>
                                </td>
                            </tr>                                                                               
                            <tr>
						  ...
						  ?>
                           <table class="table table-striped table-hover">
                            ...
                            <tr>
                                <th scope="row"><label for="company_nocompte2"><?php echo $lang_['settings']['FIELD_COMPANY_NOCOMPT']; ?></label></th>
                                <td><input class="required number" name="company_nocompte" type="text" id="company_nocompte" value="<?php echo $company_nocompte; ?>" data-array="12,12," /></td>
                            </tr>
							<tr>
                                <th scope="row"><label for="company_nocompte"><?php echo $lang_['settings']['FIELD_COMPANY_NOCOMPTE']; ?></label></th>
                                <td><input class="number" name="company_nocompte2" type="text" id="company_nocompte2" value="<?php echo $company_nocompte2; ?>" data-array="12,12," /></td>
                            </tr>   
                            <tr>
