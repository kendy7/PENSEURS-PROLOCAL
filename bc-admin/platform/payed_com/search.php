     ...
     <div class="box-content" id="body_search">
       <div class="container-fluid">
            <form id="form_ad_search">
              <div class="row-fluid">            
                <input type="text" name="id_r" id="id_r" value="" data-array="12,12,<?php echo $lang_['payed_com']['FIELD_ID']; ?>" />
              </div>     
              <div class="row-fluid">            
                <input type="text" name="idcl_r" id="idcl_r" value="" data-array="12,12,<?php echo $lang_['payed_com']['FIELD_USERID']; ?>" />
              </div>  
              <div class="row-fluid">            
                <input type="checkbox" id="enabled_r" data-icon="icon-ok icon-white" name="enabled_r" class="bootstyl" data-label-name="<?php echo $lang_['payed_com']['FIELD_SEARCH_ENABLED']; ?>" data-additional-classes="btn-info" value="1" />
                <input type="checkbox" id="disabled_r" data-icon="icon-ok icon-white" name="disabled_r" class="bootstyl" data-label-name="<?php echo $lang_['payed_com']['FIELD_SEARCH_DISABLED']; ?>" data-additional-classes="btn-info" value="1" />
              </div>  
              <br/><br/>                                                                                 
              <div calss="row-fluid">
