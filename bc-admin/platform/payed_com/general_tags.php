...
$page_title = $lang_['payed_com']['FLEX_MAIN_MENU_TITLE'];/*--> Page Title of this platform part */
...
$menu_title = $lang_['payed_com']['FLEX_MAIN_MENU_TITLE']; /*--> Menu title for this section */
$breadcrumb = '<ul class="breadcrumb">
				...
				<li class="active">
				  <i class="icon icon-gray '.$icon_menu.'"></i> '.$lang_['payed_com']['FLEX_MAIN_MENU_TITLE'].'
				</li>
               </ul>';
?>