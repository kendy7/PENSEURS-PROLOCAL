...
var model = [       
	  ...
	  {display: __('FLEX_MAIN_TITLE_ID'), name : 'id_client', width : 180, sortable : true, align: 'left'},
	  ...
	  {display: __('FLEX_MAIN_TITLE_STATUS'), name : 'payed_com', width : 50, sortable : true, align: 'center'},
