...
$mptt = new Zebra_Mptt();
 ...
 <div class="row-fluid">
   ...
   <div class="span8">
	  <table class="table table-striped table-bordered table-condensed table-hover">
		  <tr>
			  <td align="left" valign="top">'.$lang_['Salaire&Bonus']['INFO_CODE'].'</td>
			  <td align="left" valign="top">'.$rs['code'].'</td>
		  </tr>
		  <tr>
			  <td align="left" valign="top">'.$lang_['Salaire&Bonus']['INFO_AVAILABILITY'].'</td>
			  <td align="left" valign="top">'.(!$rs['unlimited_availability'] ? num_formatt($rs['availability'],2,true).' '.$rs['units'] : 'Unlimited').'</td>
		  </tr>
		  <tr>
			  <td align="left" valign="top">'.$lang_['Salaire&Bonus']['INFO_CATEGORY'].'</td>
			  <td align="left" valign="top">'.$mptt -> get_orizzontal($rs['categories'],' > ').'</td>
		  </tr>	
		  <tr>
			  <td align="left" valign="top">'.$lang_['Salaire&Bonus']['INFO_PRICE'].'</td>
			  <td align="left" valign="top">'.num_formatt($rs['price']).'</td>
		  </tr>	
		  <tr>
			  <td align="left" valign="top">'.$lang_['Salaire&Bonus']['INFO_OFFER'].'</td>
			  <td align="left" valign="top">'.($rs['offer'] > 0 ? num_formatt($rs['offer']) : '').'</td>
		  </tr>
		    <tr>
			  <td align="left" valign="top">'.$lang_['Salaire&Bonus']['INFO_POINT'].'</td>
 ...
 if($rs['attributes'] != ''){
?> 
  <strong class="text-info"><?php echo $lang_['Salaire&Bonus']['INFO_ATTRIBUTES']; ?></strong>
