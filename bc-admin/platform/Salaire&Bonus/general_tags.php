...
$page_title = $lang_['Salaire&Bonus']['FLEX_MAIN_MENU_TITLE'];/*--> Page Title of this platform part */
$icon_menu = 'icon-briefcase';/*--> Icon used for menu and table title */
$box_title = '<i class="'.$icon_menu.'"></i> '.$lang_['Salaire&Bonus']['FLEX_TABLE_TITLE']; /*--> Table title */

$table_name = $table_prefix."products";



 /*--> the database table where you want work */
...
$menu_title = $lang_['Salaire&Bonus']['FLEX_MAIN_MENU_TITLE']; /*--> Menu title for this section */
$breadcrumb = '<ul class="breadcrumb">
				...
				<li class="active">
				  <i class="'.$icon_menu.'"></i> '.$lang_['Salaire&Bonus']['FLEX_MAIN_MENU_TITLE'].'
				</li>
               </ul>';
?>