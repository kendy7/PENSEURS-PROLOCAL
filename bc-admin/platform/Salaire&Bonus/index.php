             ...
             <div class="container-fluid">
						...
						<form method="POST" action="add.php">
						 				<div class="row-fluid" id="div_1" >
											...
											<div class="row-fluid">  
												<input type="submit" class="required" name="bonus" id="bonus" value="Modifier"/>
											</div>
										</div>
										<div class="row-fluid" id="div_2" style="display:none" >
											...
											<div class="row-fluid">  
												<input type="submit" class="required" name="salaire" id="salaire" value="Modifier"/>
											</div>
										</div>
										...
										<div class="row-fluid" id="div_3" style="display:none" >
											...
											<div class="row-fluid">  
												<input type="text" class="required" name="APIp" id="name" value="<?php echo $rowpoints['API'];?>" data-array="12,4,<?php echo $lang_['Salaire&Bonus']['Pts_API']; ?>*" />
											</div>
											
											<div class="row-fluid">  
												<input type="text" class="required" name="AAJp" id="name" value="<?php echo $rowpoints['AAJ'];?>" data-array="12,4,<?php echo $lang_['Salaire&Bonus']['Pts_AJ']; ?>*" />
											</div>
											<div class="row-fluid">  
												<input type="text" class="required" name="AASp" id="name" value="<?php echo $rowpoints['AAS'];?>" data-array="12,4,<?php echo $lang_['Salaire&Bonus']['Pts_AS']; ?>*" />
											</div>
											<div class="row-fluid">  
												<input type="text" class="required" name="AARGp" id="name" value="<?php echo $rowpoints['AARG'];?>" data-array="12,4,<?php echo $lang_['Salaire&Bonus']['Pts_AARG']; ?>*" />
											</div>
											
											<div class="row-fluid">  
												<input type="text" class="required" name="AORp" id="name" value="<?php echo $rowpoints['AOR'];?>" data-array="12,4,<?php echo $lang_['Salaire&Bonus']['Pts_OR']; ?>*" />
											
											</div>
											
											<div class="row-fluid">  
												<input type="text" class="required" name="APTp" id="name" value="<?php echo $rowpoints['APT'];?>" data-array="12,4,<?php echo $lang_['Salaire&Bonus']['Pts_PT']; ?>*" />
											</div>
											
											<div class="row-fluid">  
												<input type="text" class="required" name="AEMp" id="name" value="<?php echo $rowpoints['AEM'];?>" data-array="12,4,<?php echo $lang_['Salaire&Bonus']['Pts_EM']; ?>*" />
											</div>
											<div class="row-fluid">  
											...
											<div class="row-fluid">  
												<input type="submit" class="required" name="points" id="points" value="Modifier"/>
											</div>
										...
										<div class="row-fluid" id="div_4" style="display:none" >
											...
											<div class="row-fluid">  
												<input type="text" class="required" name="API" id="name" value="<?php echo $rowcommission['API'];?>" data-array="12,4,<?php echo $lang_['Salaire&Bonus']['com_API']; ?>*" />
											</div>
											
											<div class="row-fluid">  
												<input type="text" class="required" name="AAJ" id="name" value="<?php echo $rowcommission['AAJ'];?>" data-array="12,4,<?php echo $lang_['Salaire&Bonus']['com_AJ']; ?>*" />
											</div>
											<div class="row-fluid">  
												<input type="text" class="required" name="AAS" id="name" value="<?php echo $rowcommission['AAS'];?>" data-array="12,4,<?php echo $lang_['Salaire&Bonus']['com_AS']; ?>*" />
											</div>
											<div class="row-fluid">  
												<input type="text" class="required" name="ARG" id="name" value="<?php echo $rowcommission['ARG'];?>" data-array="12,4,<?php echo $lang_['Salaire&Bonus']['com_AARG']; ?>*" />
											</div>
											
											<div class="row-fluid">  
												<input type="text" class="required" name="AOR" id="name" value="<?php echo $rowcommission['AOR'];?>" data-array="12,4,<?php echo $lang_['Salaire&Bonus']['com_OR']; ?>*" />
											
											</div>
											
											<div class="row-fluid">  
												<input type="text" class="required" name="APT" id="name" value="<?php echo $rowcommission['APT'];?>" data-array="12,4,<?php echo $lang_['Salaire&Bonus']['com_PT']; ?>*" />
											</div>
											
											<div class="row-fluid">  
												<input type="text" class="required" name="AEM" id="name" value="<?php echo $rowcommission['AEM'];?>" data-array="12,4,<?php echo $lang_['Salaire&Bonus']['com_EM']; ?>*" />
											</div>
											
											<div class="row-fluid">  
												<input type="text" class="required" name="ADM" id="name" value="<?php echo $rowcommission['ADM'];?>" data-array="12,4,<?php echo $lang_['Salaire&Bonus']['com_DM']; ?>*" />
											</div>
											
											
											<div class="row-fluid">  
												<input type="submit" class="required" name="commission" id="commission" value="Modifier"/>
											</div>
										</div>
