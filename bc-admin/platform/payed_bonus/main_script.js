...
var model = [       
	  ...
	  {display: __('FLEX_MAIN_TITLE_USERID'), name : 'userid', width : 180, sortable : true, align: 'left'},
	  {display: __('FLEX_MAIN_TITLE_DATE'), name : 'Datee', width : 180, sortable : true, align: 'left'},
	  {display: __('FLEX_MAIN_TITLE_MONTANT'), name : 'montant', width : 200, sortable : true, align: 'left'},
	  {display: __('FLEX_MAIN_TITLE_STATUS'), name : 'payed_bonu', width : 50, sortable : true, align: 'center'},
...
function submit_form($url){
			   ...
			   $('#container_form form:first').validate({
					...
					messages:{
					  ...
					  //nif: {remote:__('INSERT_UPDATE_DUPLICATE_NIF_ERROR')}
					},
					ignore:'.ignore'
				});	
