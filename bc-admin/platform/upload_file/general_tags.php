...
$page_title = $lang_['upload_file']['FLEX_MAIN_MENU_TITLE'];/*--> Page Title of this platform part */
$icon_menu = 'icon-users';/*--> Icon used for menu and table title */
$box_title = '<i class="icon icon-black '.$icon_menu.'"></i> '.$lang_['upload_file']['FLEX_TABLE_TITLE']; /*--> Table title */
...
$menu_title = $lang_['upload_file']['FLEX_MAIN_MENU_TITLE']; /*--> Menu title for this section */
$breadcrumb = '<ul class="breadcrumb">
				...
				<li class="active">
				  <i class="icon icon-gray '.$icon_menu.'"></i> '.$lang_['upload_file']['FLEX_MAIN_MENU_TITLE'].'
				</li>
               </ul>';
?>