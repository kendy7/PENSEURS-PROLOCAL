...
var model = [       
	  ...
	  {display: __('FLEX_MAIN_TITLE_CODEMEMBRE'), name : 'CodeMembre', width : 180, sortable : true, align: 'left'},
	  ...
	  {display: __('FLEX_MAIN_TITLE_SEXE'), name : 'sex', width : 200, sortable : true, align: 'left'},
	  ...
	  {display: __('FLEX_MAIN_TITLE_REFERENCE'), name : 'reference', width : 120, sortable : true, align: 'left'},
