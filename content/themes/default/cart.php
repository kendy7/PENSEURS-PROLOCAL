	     ...
	     <div class="navbar">
             <div class="navbar-inner">
                 <ul class="nav">
					  ...
					  <li class="active"><a href="<?php echo abs_client_path ?>/cart.php"><?php echo $lang_client_['general']['TEXT_SHOPPING_CART']; ?></a></li>
		  ...
		  <?php
		   ...
		   while($rs_cart = mysql_fetch_array($cart_items)){	 	
			  ...
			  foreach($arr_cart_options as $key => $val){
				...
				$pointTotal=$rs_cart['point']*$qta;$qty=$qty+$qta;
execute("update ag_cart set point= ".$pointTotal." where id=".$rs_cart['id_product_cart']." and session_client= '".get_initial_user_session()."'");
				$pointot=$pointot+$rs_cart['point']*$qta;
				...
				$products_rows .= ' <tr>
										...
										<td data-title="'.$lang_client_['cart']['TABLE_CONTENT_TITLE_UNIT_POINT'].'">'
										  .$rs_cart['point'].'
										</td>
										<td data-title="'.$lang_client_['cart']['TABLE_CONTENT_TITLE_TOTAL'].'">'
										  .$pointTotal.'
										</td>
              ...
              <div class="alert-cart-container row-fluid<?php echo $alert_hide; ?>">
                <div class="span12">
                   <div class="alert alert-warning alert-block squared solid unbordered"><h4><?php echo $lang_client_['cart']['ALERT_CART_EMPTY']; ?></h4></div>
                    <br/>
                    <a class="btn btn-info btn-large squared solid unbordered pull-right" href="<?php echo abs_client_path; ?>/Produits.php"><?php echo $lang_client_['general']['BUTTON_RETURN_TO_SHOPPING']; ?></a>                   
                </div>
              </div>
                                ...
                                <table class="table-striped table-condensed">
                                    <thead>
                                        <tr>
											...
											<th ><?php echo $lang_client_['cart']['TABLE_CONTENT_TITLE_UNIT_POINT']; ?></th>
                                            <th ><?php echo $lang_client_['cart']['TABLE_CONTENT_TITLE_TOTAL']; ?></th>
                 ...
                 <div class="span4">
                                ...
                                <table class="table table-hover table-striped pull-right">
                                    <tbody class="counts-container">
										...
										<tr>
                                            <td><strong><?php echo $lang_client_['cart']['TABLE_CONTENT_POINT_TOTAL']; ?>:</strong></td>
                                            <td class="subtotal"><?php echo (!$prices_on_login ? $pointot : '')." point(s)"; ?></td>
                                        </tr>
										...
										?>
                                        <tr>
                                            <td><strong><?php echo $lang_client_['cart']['TABLE_CONTENT_TITLE_GRANDTOTAL']; ?>:</strong></td>
                                ...
                                <div class="row-fluid">
                                  <div class="span6 text-left">
                                    <a class="btn btn-info squared solid unbordered btn-block" href="<?php echo abs_client_path; ?>/Produits.php"><?php echo $lang_client_['general']['BUTTON_RETURN_TO_SHOPPING']; ?></a>
                                  </div>
                                  <div class="span6">
