       ...
       <section class="span4 left-sidebar-container search-sidebar"> 
         <aside class="left-sidebar">
          <nav class="accordion_menu_container">
            ...
            Recherche avec: <label class="checkbox" for="sp_n"><input type="checkbox" data-toggle="checkbox" id="sp_n" <?php echo (isset($get_sp_n) ? ' checked' : (!isset($get_sp_n) && !isset($get_sp_t) && !isset($get_sp_d) && !isset($get_sp_mk) ? ' checked' : '')); ?> /><?php echo $lang_client_['search']['FIELD_LABEL_NAME']; ?></label>
