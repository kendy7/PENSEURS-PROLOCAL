	     ...
	     <div class="navbar">
             <div class="navbar-inner">
                 <ul class="nav">
					  ...
					  <li><a href="<?php echo abs_client_path; ?>/Rapport.php"><?php echo $lang_client_['client_account']['MENU_RAPPORT']; ?></a></li>					  <li><a href="<?php echo abs_client_path; ?>/network.php" target="Blanck_"><?php echo "Reseau"; ?></a></li>
	...
	<?php 
		 ...
		 /********* CART PRODUCTS **************/
		   ...
		   $cart_items = execute('select '.$table_prefix.'products.*,
								  ...
								  '.$table_prefix.'cart.point as cart_point
		   ...
		   while($rs_cart = mysql_fetch_array($cart_items)){	 	
			  ...
			  foreach($arr_cart_options as $key => $val){
				...
				$row_options .= '<tr>
								<td class="text-left"<strong>'.$rs_cart['name'].'</strong></td>
				...
				$products_rows .= '<tbody id="product_'.$rs_cart['id_product_cart'].'">
									'.$row_options.'
    ...
    ?>       
      <div class="alert-cart-container row-fluid<?php echo $alert_hide; ?>">
        <div class="span12">
           <div class="alert alert-warning alert-block squared solid unbordered"><h4><?php echo $lang_client_['checkout']['ALERT_CART_EMPTY']; ?></h4></div>
            <br/>
            <a class="btn btn-info btn-large squared solid unbordered pull-right" href="<?php echo abs_client_path; ?>Produits"><?php echo $lang_client_['general']['BUTTON_RETURN_TO_SHOPPING']; ?></a>                   
        </div>
      </div> 
      <div class="order-success row-fluid hide">
        <div class="span4 offset4" style="text-align:jusyify;">
           <div class="alert alert-success alert-block squared solid unbordered"><h4><?php echo str_replace('{link}',abs_client_path.'/contacts.php',str_replace('{link_name}',$lang_client_['general']['TEXT_CONTACT_US'],$lang_client_['checkout']['ALERT_ORDER_SUCCESS'])); ?>           
            ...
            <br/>
            <a class="btn btn-info btn-large squared solid unbordered pull-right return-shopping" href="<?php echo abs_client_path; ?>/compte.php"><?php echo $lang_client_['general']['BUTTON_RETURN_TO_COMPTE']; ?></a>                   
        </div>
      </div>          
     <section class="row-fluid checkout-page<?php echo $list_show; ?>"><!-- BODY ROW -->            
	    <aside class="span5">
          ...
          <span data-steps-rel="fstep_<?php echo !isset($_SESSION['Clogged']) && $guest_purchases ? '2' : '2'; ?>" data-steps-rel-form="checkout-form" class="check-step"><h5><?php echo $lang_client_['checkout']['ORDER_PROGRESS_INDICATOR_PAYMENT']; ?></h5></span>
          <span data-steps-rel="fstep_<?php echo !isset($_SESSION['Clogged']) && $guest_purchases ? '4' : '3'; ?>" data-steps-rel-form="checkout-form" class="check-step"><h5><?php echo $lang_client_['checkout']['ORDER_PROGRESS_INDICATOR_SUMMARY']; ?></h5></span>
          <!--span data-steps-rel="fstep_<?php// echo !isset($_SESSION['Clogged']) && $guest_purchases ? '6' : '5'; ?>" data-steps-rel-form="checkout-form" class="check-step"><h5><?php //echo $lang_client_['checkout']['']; ?></h5></span-->                   
        </aside>
		   ...
		   ?>
			...
			?>                   
             <div class="principal_address" id="fstep_<?php echo !isset($_SESSION['Clogged']) && $guest_purchases ? '2' : '1'; ?>">
				  ...
				  ?>                                   
                  <div class="row-fluid">
                    <input type="text" class="required email" name="email" id="email" value="<?php echo (isset($_SESSION['Clogged']) ? $rs_cli['email'] : ''); ?>" data-array="12,6,<?php echo $lang_client_['checkout']['FIELD_LABEL_EMAIL']; ?>*" />
                    <input type="text" class="required" name="phone" id="phone" value="<?php echo (isset($_SESSION['Clogged']) ? $rs_cli['phone'] : ''); ?>" data-array="12,6,<?php echo $lang_client_['checkout']['FIELD_LABEL_PHONE']; ?>*" /> 
                  </div>      
                  <div class="row-fluid">  
                    <input type="text" class="required" name="address" id="address" value="<?php echo (isset($_SESSION['Clogged']) ? $rs_cli['address'] : ''); ?>" data-array="12,6,<?php echo $lang_client_['checkout']['FIELD_LABEL_ADDRESS']; ?>*" />
            ...
            <!-- cette portion de code est reservee en cas il y a livraison a domicile
			...
			div class="same_address" id="fstep_<?php //echo !isset($_SESSION['Clogged']) && $guest_purchases ? '3' : '2'; ?>">
                  <div class="box-header">
					 ...
					 <div class="row-fluid">
					   <div class="span6">
						<input type="radio" class="required" name="optionsRadios" id="optionsRadios1"  onclick="show_div(2)"  value="option1"  />
					    <?php //echo $lang_client_['checkout']['Livraison1']; ?>
                    ...
                    <input type="radio" class="required" name="optionsRadios" id="optionsRadios2" onclick="show_div(1)"  value="option2"/>
                    <?php //echo $lang_client_['checkout']['Livraison2']; ?>
					--
                    </div>
                  </div>						
               ...
               <div id="div_1" class=" hide row-fluid"> 
				   ...
				   <div class="span12">	
			        ...
			        <div class="row-fluid">	
                       <input type="checkbox"  id="same-address" data-icon="icon-ok icon-white" name="same-address" class="bootstyl" data-label-name="<?php// echo $lang_client_['checkout']['BUTTON_COPY_BILLING_ADDRESS_TEXT']; ?>" data-additional-classes="btn-success btn-large btn-block solid unbordered squared" value="1" data-array="12,12," />
                    </div>
                  ...
                  <div class="row-fluid">
                    <input type="text" class="required email" name="emails" id="emails" value="" data-array="12,6,<?php //echo $lang_client_['checkout']['FIELD_LABEL_EMAIL']; ?>*" />
                    <input type="text" class="required" name="phones" id="phones" value="" data-array="12,6,<?php //echo $lang_client_['checkout']['FIELD_LABEL_PHONE']; ?>*" /> 
                  </div>      
                  <div class="row-fluid"> 
                    <input type="text" class="required" name="addresss" id="addresss" value="" data-array="12,6,<?php// echo $lang_client_['checkout']['FIELD_LABEL_ADDRESS']; ?>*" />
             ...
             <div id="fstep_<?php echo !isset($_SESSION['Clogged']) && $guest_purchases ? '3' : '2'; ?>" class="payment_method">
                  <div class="box-header">
                ...
                <div class="row-fluid"> 
				   ...
				   ?> 
                    <label for="payment_<?php echo $bank_transfer['orders_prefix']; ?>" class="only_for_register selected selected">
                       <strong><?php echo $lang_client_['checkout']['ORDER_PROGRESS_PAYMENT']; ?></strong>
                       <br/>
                       <input type="radio" name="payment_method" id="payment_<?php echo $bank_transfer['orders_prefix']; ?>" value="<?php echo $bank_transfer['orders_prefix']; ?>" checked />
             ...
             <div id="fstep_<?php echo !isset($_SESSION['Clogged']) && $guest_purchases ? '4' : '3'; ?>">
                  <div class="box-header">
                  ...
                  <table class="table-striped table-condensed products-list-table">
                      <thead>
                          <tr>
                              ...
                              <th class="text-left"><?php echo $lang_client_['checkout']['TABLE_CONTENT_TITLE_PRODUCT_UNIT_PRICE']; ?></th>
                              <th class="text-right"><?php echo $lang_client_['checkout']['TABLE_CONTENT_TITLE_SUBTOTAL']; ?></th>
                              <th class="text-right"><?php echo $lang_client_['checkout']['TABLE_CONTENT_TITLE_POINT']; ?></th>
                          </tr>
                      </thead> 
                      <?php echo $products_rows; ?>
                      <tfoot>
                          <tr>
						     <td class="text-right"><span class="subtotal-container"></span></td>
							 <td class="text-right" colspan="0"><?php echo $lang_client_['checkout']['TABLE_CONTENT_TITLE_TOTAL']; ?></td>
                          ...
                          <tr>
				             <td class="text-right"><span class="tax-container"></span></td>
							 <td class="text-right" colspan="0"><?php echo $lang_client_['checkout']['TABLE_CONTENT_TITLE_TOT_POINT']; ?></td>
				             <td class="text-right"><span class="tax-container"></span></td>
                              <td class="text-right"><span class="tax-container"><?php echo $sumpt; ?></span></td>
                          </tr>
						  <?php
