  ...
  <?php require_once('include/body-header.php');?> 
   ...
   <!----------------------------------------------------- Le corps de la page de la page de l'index ---------------------------------------- -->
							            ...
							            <div class="container-semifluid">
										 ...
										 <!--    Start Hero Caption    -->
										  <section class="caption">
											<div class="row-fluid">
											 <div class="span12">
											  <h1 class="mean_cap">Vivez bien votre Vie avec les produits bio de Prolocal</h1>
											 </div>
											  <div class="row-fluid">
											  <div class="span12">
											  <h2 class="sub_cap">Votre santé est notre priorité</h2>
	...
	<section class="container-fluid services" id="services">		  
      ...
      <div class="row-fluid">        
        <h1 class="mean_title">Jouir votre vie mieux avec Prolocal</h1>
    ...
    <section class="quote">
        <blockquote>
          ...
          <hr/>
          <span class="author strong">P.M.M.E</span>
        </blockquote>
    </section>
						  <!----------------- Fin AG en Image ----------
