...
<html lang="<?php echo $B_language; ?>">
  <head>
    ...
    <link href="<?php echo theme_css_path ?>/style.css" rel="stylesheet"> 
	<link href="<?php echo theme_css_path ?>/style1.css" rel="stylesheet">
    <link href="<?php echo theme_css_path ?>/datepicker3.css" rel="stylesheet">	
    <!-- Le fav and touch icons -->
    <link rel="shortcut icon" href="<?php echo path_img_front ?>/ico/ga.ico">
