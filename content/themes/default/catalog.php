     ...
     <section class="row-fluid"><!-- BODY ROW --> 
       <section class="span4 left-sidebar-container"> 
           ...
           <aside class="left-sidebar">
               ...
               <div class="head default-head">
                  <div class="box-header">
                     <span class="header-text clr3"><?php echo $lang_client_['catalog']['HEAD_FILTERS_BOX']; ?></span>
                  </div>          
               </div>
	    ...
	    <section class="span8">
         ...
         ?>
            <section id="filter-bar" class="span12 clr2">
