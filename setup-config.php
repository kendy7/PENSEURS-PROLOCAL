  ...
  <body>
   ...
   <?php
	  ...
	  switch($step) {
		  case 0:	  
   ?>
          <p>Bienvenu(e) sur ProLocal. Avant de commencer, On a besoin quelque information sur la base de donnée.  Nous aurons besoin de connaitre ses informations avant de continuer.</p>
          <ol>
              <li>Nom de la base de donnée</li>
              <li>Nom d'utilisateur</li>
              <li>Mot de passe</li>
              <li>Hote de la base de donnée</li>
              <li>Table prefix ( Si vous voulez utiliser ProLocal dans une simple base de donnée)</li>
          </ol>
